            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col col-xl-12">
                    <div class="justify-content-center">
                        <h1 class="title">Unidade de Medida</h1>
                    ...
                    <div class="card">
                        <div class="card-body p-5">
                            ...
                            <form class="d-flex justify-content-center align-items-center mb-4" action="cad_unidade_inserir.php" method="post">
                            <div class="cal-md-12 col-lg-10">    
                                <div class="row">
                                    <div class="col-2">
                                        <div class="form-group mb-3" class="col-md-2">
                                            <label class="label">Unidade</label>
                                            <input type="text" placeholder="Unidade" class="form-control" name="uni_unidade" id="uni_unidade">
                                        </div>
                                    </div>
                                    <div class="col-10">
                                        <div class="form-group mb-3" class="col-md-2">
                                            <label class="label">Descrição Unidade</label>
                                            <input type="text" placeholder="Descrição" class="form-control" name="uni_descricao" id="uni_descricao" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
